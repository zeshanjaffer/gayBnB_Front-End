...
export default function SliderComponent() {
  return (
    <div className="md:mt-[120px] w-full h-auto bg-[#242424] rounded-[50px] flex flex-col items-center justify-center px-6 py-10 mx-auto">
      {/* Tag */}
      ...
      {/* Heading */}
      <h1 className="text-white text-[40px] sm:text-[48px] md:text-[60px] lg:text-[65px] font-[700] leading-tight text-center font-[Satoshi] mt-4">
        Amazing LGBTQ Friendly Places <br /> to Stay around the world
      </h1>

      {/* Paragraph */}
      <p className="text-white text-[16px] sm:text-[18px] font-[400] leading-[28px] text-center font-[Satoshi] mt-4 max-w-[900px]">
