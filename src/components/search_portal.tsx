...
const SearchPortal: React.FC<SearchPortalProps> = () => {
  return (
    <div
      className="w-[1238px] max-w-[90vw] h-[152px] md:h-auto rounded-[24px] shadow-[0_40px_64px_-32px_rgba(15,15,15,0.1)] backdrop-blur-[32px] p-6 mx-auto"
      style={{ top: '697px', left: 'auto', right: 'auto', marginTop: '-40px' }}
    >
