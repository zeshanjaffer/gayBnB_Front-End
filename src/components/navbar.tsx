    ...
    <nav className="fixed top-0 left-0 w-full bg-gray-700/30 backdrop-blur-md z-50">
      <div className="container mx-auto flex items-center justify-between px-6 py-4">
        ...
        <div className="hidden md:flex space-x-8">
          <Link href="/" className="text-white text-lg font-semibold">LGBTQ+ HOTSPOTS</Link>
          <Link href="/" className="text-white text-lg font-semibold">GAYBNB YOUR PROPERTY</Link>
