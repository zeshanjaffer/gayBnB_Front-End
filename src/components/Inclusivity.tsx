      ...
      <div className="max-w-[1280px] w-full">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10">
          ...
          <div className="w-full lg:w-[610px] flex flex-col gap-6">
            <div className="flex sm:flex-row justify-center gap-6">
              {/* Card 1 */}
              <div className="w-full sm:w-[295px] h-[140px] sm:h-[227.68px] rounded-[50px] bg-white flex flex-col items-center justify-center shadow-xl md:shadow-md">
            ...
            <div className="flex sm:flex-row justify-center gap-6 pb-5 md:pb-0">
              {/* Image */}
              <div className="w-full sm:w-[295px] h-[140px] sm:h-[227.68px] rounded-[50px] overflow-hidden">
                <Image
                  src="/inclusivity.png"
                  alt="Inclusivity"
                  width={295}
